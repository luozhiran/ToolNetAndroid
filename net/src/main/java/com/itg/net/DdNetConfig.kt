...
class DdNetConfig {
    ...
    fun app(application: Application): DdNetConfig {
        this.application = application
        pkgName = application.packageName
        return this
    }

    fun url(url: String?): DdNetConfig {
        this.url = url
        return this
    }

    fun setGlobalParams(key: String, value: Any): DdNetConfig {
    ...
    fun addInterceptor(interceptor: Interceptor): DdNetConfig {
    ...
    fun log(path: String?): DdNetConfig {
        logPath = path
        return this
    }
     ...
     * @return DdNetConfig
     */
    fun okHttpClient(okHttpClient: OkHttpClient?): DdNetConfig {
